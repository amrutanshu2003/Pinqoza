    ...
    <div className="space-y-10">
      ...
      <section className="pt-1">
        <div className="flex items-end justify-between gap-4">
          ...
          <Link to="/products?sort=rating_desc" className={`text-sm font-semibold self-end ${isDarkMode ? 'text-gray-200 hover:text-white' : 'text-gray-700 hover:text-gray-900'}`}>
            Explore
          </Link>
        </div>
